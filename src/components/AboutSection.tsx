...
const stats = [
  ...
  { icon: TrendingUp, value: 15, suffix: "%", label: "Demand Forecasting Improvement" },
  { icon: Award, value: 17, suffix: "%", label: "Cost Savings Delivered" },
];
...
const AnimatedCounter = ({ value, suffix }: { value: number; suffix: string }) => {
  ...
  return (
    <span ref={ref} className="text-4xl lg:text-5xl font-bold text-gradient">
      {count}
      {suffix}
    </span>
  );
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                {["Data Analytics", "ETL Optimization", "Machine Learning", "BI Reporting"].map(
                  (skill) => (
                    <span
                      key={skill}
