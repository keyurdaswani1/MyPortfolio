      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        duration: 0.6
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mt-3 mb-4">Modernizing Data Problems with AI Solutions
Turning Data into Strategic Insights<span className="text-gradient">Strategic Insights</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">Turning Data into Strategic Insights
A results-driven Data Professional with expertise in transforming complex data into actionable business strategies.</p>
          </div>
